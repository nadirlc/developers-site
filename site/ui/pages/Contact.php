...
class Contact extends BasePage
{
    ...
    protected function UpdateScripts() : void
    {
        ...
        /** The Contact page JavaScript files are merged with the custom JavaScript files */
	...
	{	    
        ...
        $sql              = "INSERT INTO " . $table_name . " (name, email, message, created_on) VALUES(?,?,?,?)";
        /** The query parameters */
        $query_params     = array($name, $email, $message, time());
        /** The row is added */
...
EOT;
    ...
    protected function GetBody(?array $params = null) : string
    {
    	...
    	$body_html  = Config::GetComponent("templateengine")->Generate("contact", $tag_values);
